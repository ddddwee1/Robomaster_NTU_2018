...
def build_model(inp_holder):
	...
	feat3 = mod.convLayer(3,128,stride=2,activation=M.PARAM_LRELU)#30_ 32x32
	bias3 = mod.convLayer(1,4)
	mod.set_current(feat3)
	conf3 = mod.convLayer(1,1)

	return bias1[0],bias3[0],conf1[0],conf3[0]
...
def loss_function(bias,conf,b_lab,c_lab):
	...
	return bias_loss + conf_loss*10

def build_loss(model_out,b_lab,c_lab):
	b0,b1,c0,c1 = model_out
	loss_functions = []
	loss_functions.append(loss_function(b0,c0,b_lab,c_lab)*16)
