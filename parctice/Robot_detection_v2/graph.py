...
def build_graph(test=False):
	...
	# cropped_map = fmCrop(feature_map)
 	veri_conf, veri_bias = verify_net(cropped_map)
	...
	veri_train_step = tf.train.AdamOptimizer(0.00001).minimize(veri_bias_loss+veri_conf_loss)

	return [imgholder,bias_holder, conf_holder], [croppedholder, veri_bias_holder, veri_conf_holder], [bias_loss, conf_loss], [veri_bias_loss, veri_conf_loss], [train_step, veri_train_step], [conf, bias] , [veri_conf,veri_bias]
