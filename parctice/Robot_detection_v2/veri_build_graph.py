...
def build_graph():
	...
	# cropped_map = fmCrop(feature_map)
 	veri_conf, veri_bias = veri(cropped_map)
	...
	return imgholder,bias_holder, conf_holder, veri_bias_holder, veri_conf_holder, bias_loss, conf_loss, veri_bias_loss, veri_conf_loss, train_step, veri_train_step, conf, bias,veri_conf,veri_bias
