...
def get_digits2(image):  #hansel's version, returns the coords or the handwritten digits
	...
	handwritten_coords = get_original_handwritten_coords(pts2,pts1, warped_digit_coords)
	...
	return coord, handwritten_num, Flaming_digit, handwritten_coords
def get_original_handwritten_coords( warped_corners,original_corners, warped_points):
	"""
	Parameters
	----------
	...
	original_points: list
		Original points in original image converted from points in warped image	
	"""
