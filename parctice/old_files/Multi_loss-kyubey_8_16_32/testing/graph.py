...
class build_graph:
	...
	def build_loss(self,b0,b1,b2,c0,c1,c2,b_lab,c_lab):
		loss_functions = []
		loss_functions.append(self.loss_function(b0,c0,b_lab,c_lab,4.))
		loss_functions.append(self.loss_function(b1,c1,b_lab,c_lab))
		loss_functions.append(self.loss_function(b2,c2,b_lab,c_lab,1./4.))
...
#		veri_bias_loss = tf.reduce_sum(tf.reduce_mean(tf.square(veri_bias*veri_conf_holder - veri_bias_holder),axis=0))
		...
		veri_train_step = tf.train.AdamOptimizer(0.000001).minimize(veri_conf_loss)
