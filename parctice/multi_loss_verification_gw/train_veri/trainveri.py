...
with tf.Session() as sess:
	...
	M.loadSess('drive/Colab/multi_loss_verification/train_veri/model/',sess,init=True,var_list=M.get_trainable_vars('MSRPN'))
	for i in range(MAXITER):
		...
		if i%3000==0 and i>0:
			saver.save(sess,'drive/Colab/multi_loss_verification/train_veri/modelveri/%d.ckpt'%i)
