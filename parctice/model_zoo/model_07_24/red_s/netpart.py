...
def build_model(inp_holder):
	with tf.variable_scope('MSRPN_v3_s'):
		...
		mod.dwconvLayer(7,4,stride=2,activation=M.PARAM_LRELU,batch_norm=True)
		mod.convLayer(5,16,stride=2,activation=M.PARAM_LRELU,batch_norm=True) #480_ 2x2	
		# mod.convLayer(5,32,stride=2,activation=M.PARAM_LRELU) #240_ 4x4
		c1 = mod.convLayer(3,32,stride=2,activation=M.PARAM_LRELU,batch_norm=True) #120_ 8x8
	...
	return bias1,bias3,conf1,conf3
