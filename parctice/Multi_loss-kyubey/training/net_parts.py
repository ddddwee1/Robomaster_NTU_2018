...
def multiloss_RPN(inp,test):
	with tf.variable_scope('mainModel'):
		...
		c0 =mod.convLayer(5,32,stride=2,activation=M.PARAM_LRELU) #120_ 8x8
		mod.convLayer(4,64,activation=M.PARAM_LRELU)
		...
		mod.set_current(c0)
		c1 = mod.convLayer(4,64,stride=2,activation=M.PARAM_LRELU) #60_ 16x16
		...
		mod.set_current(c1)
		c2 = mod.convLayer(4,64,stride=2,activation=M.PARAM_LRELU) #30_ 32x32
